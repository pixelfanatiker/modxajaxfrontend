...
$templates[1]->fromArray(array(
    ...
    'content' => file_get_contents($modMediaSources['source_core'].'/elements/templates/mytemplate1.tpl'),
    'properties' => '',
),'',true,true);
...
$templates[2]->fromArray(array(
    ...
    'content' => file_get_contents($modMediaSources['source_core'].'/elements/templates/mytemplate2.tpl'),
    'properties' => '',
),'',true,true);
