...
$plugins[1]->fromArray(array(
    ...
    'plugincode' => getPluginContent($modMediaSources['source_core'].'/elements/plugins/myplugin1.plugin.php'),
),'',true,true);
$properties = include $modMediaSources['data'].'properties/properties.myplugin1.php';
...
$plugins[2]->fromArray(array(
    ...
    'plugincode' => getPluginContent($modMediaSources['source_core'].'/elements/plugins/myplugin2.plugin.php'),
),'',true,true);
$properties = include $modMediaSources['data'].'properties/properties.myplugin2.php';
