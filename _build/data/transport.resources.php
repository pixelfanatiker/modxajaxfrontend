...
$resources[1]->setContent(file_get_contents($modMediaSources['build'] . 'data/resources/resource1.content.html'));
...
$resources[2]->setContent(file_get_contents($modMediaSources['build'] . 'data/resources/resource2.content.html'));
